...
train = read_csv("./EMNISTcsv/emnist-balanced-train.csv",delimiter = ',') #uncomment for balanced
test = read_csv("./EMNISTcsv/emnist-balanced-test.csv", delimiter = ',') #uncomment for balanced
